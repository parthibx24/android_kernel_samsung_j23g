...
/* PANEL_INIT_CMD and PANEL_ENABLE_CMD: be transmitted before it starts
   to transfer FB data via DSI bus.
   PANEL_POST_ENABLE_CMD: be transmitted after it starts to transfer FB data.
 */
enum {
	PANEL_INIT_CMD,
	PANEL_ENABLE_CMD,
